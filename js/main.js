...
$('.contact-form').on('click', function (event) {
    ...
    var sendBtn = form.find('[name=send]');

    var msgContactForm = form.find(".msgContactForm");
    var email = form.find('[name=email]');
    var phone_number = form.find('[name=phone]');
    var name = form.find('[name=name]');
    var comment = form.find('[name=comment]');

    if(!validateEmail(email.val())) {
        email.addClass("tz_input_error bg-danger");
        msgContactForm.text("Email non valida");
    } else if(isBlank(phone_number.val())) {
        phone_number.addClass("tz_input_error bg-danger");
        msgContactForm.text("Telefono obbligatorio");
    } else {
        email.removeClass("tz_input_error bg-danger");
        phone_number.removeClass("tz_input_error bg-danger");
        msgContactForm.text("");
        ...
        $.ajax({
            ...
            success: function(data, statusText, xhr){
                console.log( "Data Saved: " + data + " " + statusText + " " + xhr.status );
                msgContactForm.text("Richiesta inviata");
            },
            error: function(data, statusText, xhr) {
                console.log("some error: " + data + " " + statusText + " " + xhr.status);
                msgContactForm.text("Si è verificato un errore");
